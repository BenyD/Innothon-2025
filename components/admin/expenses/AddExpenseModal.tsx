...
export function AddExpenseModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px] p-0 bg-neutral-950 border border-neutral-800 w-[95vw] sm:w-full mx-2 sm:mx-0">
        <DialogHeader className="p-4 sm:p-6 pb-4 bg-gradient-to-r from-teal-400/10 to-emerald-400/10 border-b border-neutral-800">
          <DialogTitle className="text-xl sm:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-emerald-400">
            Add New Expense
          </DialogTitle>
        ...
        <ScrollArea className="max-h-[80vh] p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-3 sm:space-y-0 sm:flex sm:flex-row gap-4 pt-2">
